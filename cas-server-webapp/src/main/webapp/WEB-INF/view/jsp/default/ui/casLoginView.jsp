...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form:form method="post" action="login" id="fm1" class="login-form" commandName="${commandName}" htmlEscape="true">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<form:input cssClass="form-control placeholder-no-fix" placeholder="Username" id="username" path="username" autocomplete="false" htmlEscape="true"/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<form:password cssClass="form-control placeholder-no-fix" placeholder="Password" id="password" path="password" autocomplete="off" htmlEscape="true"/>
			</div>
		</div>
